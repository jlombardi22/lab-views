...
def problem_one(request):
    ...
    students = Student.objects.filter(gpa__gte=3.5).order_by('-gpa')
    for student in students:
        print(
            f'Students full name: {student.first_name} {student.last_name}, and GPA is : {student.gpa}')
...
def problem_two(request):
    ...
    instructors = Instructor.objects.filter(
        hire_date__lt='2010-01-01').order_by('hire_date')
    for instructor in instructors:
        print(
            f'full Name: {instructor.first_name} {instructor.last_name} \n & Hire date was {instructor.hire_date}')
    return complete(request)
...
def problem_three(request):
    instructor_one = Instructor.objects.get(id=2)
    print(instructor_one.first_name, instructor_one.last_name)
...
def problem_four(request):
    ...
    print(
        f'Students Count: {students}, Courses count: {courses}, Instructors count: {instructors}')
...
def problem_five(request):
    student = Student.objects.create(
        first_name='Johnny', last_name='Lombardi', year=9, gpa=3.0)
    print(f'Id: {student.id}, student full name: {student.first_name} {student.last_name}, student year: {student.year}, student GPA: {student.gpa}')
...
def problem_six(request):
    ...
    print(f'students name: {student.first_name}, updated gpa: {student.gpa}')
